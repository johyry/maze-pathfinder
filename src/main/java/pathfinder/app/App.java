...
//        BitmapHandler bitmapHandler = new BitmapHandler("mazes/example1.bmp"); // koko 5x5 TÄYDELLINEN
//        BitmapHandler bitmapHandler = new BitmapHandler("mazes/example2.bmp"); // koko 101x101 TÄYDELLINEN
//        BitmapHandler bitmapHandler = new BitmapHandler("mazes/example3.bmp"); // koko 1001x1001 TÄYDELLINEN
//         BitmapHandler bitmapHandler = new BitmapHandler("mazes/example4.bmp"); // 501x501 TÄYDELLINEN
//        BitmapHandler bitmapHandler = new BitmapHandler("mazes/example5.bmp"); // Koko 2501X2501 TÄYDELLINEN
//        BitmapHandler bitmapHandler = new BitmapHandler("mazes/example6.bmp"); // Koko 5001x5001 TÄYDELLINEN
//        BitmapHandler bitmapHandler = new BitmapHandler("mazes/example7.bmp"); // koko 15x15 TÄYDELLINEN
//
...
////        thremaux.printMarks();
//
//        bitmapHandler.generateJPGImageFromArray(thremaux.getMarked(), "1");
//
////        LeftWallFollower lfw = new LeftWallFollower(maze, start, goal);
////        lfw.init();
////
////        bitmapHandler.generateJPGImageFromArray(lfw.getMarked(), "2");
